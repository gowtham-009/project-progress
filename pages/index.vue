              ...
              <thead>
                <tr>
                  <th class="px-6 py-8 text-left text-md font-medium text-gray-600 uppercase  tracking-widergap-1">
                    <p>Customer ID<button @click="toggleSortOrder" class="p-0 text-red-500" style="margin-top: -9%;">
                  ...
                  <th class="px-6 py-3 text-left text-md font-medium text-gray-600 uppercase tracking-wider">Purchased
                  </th>
                  <th class="px-6 py-3 text-left text-md font-medium text-gray-600 uppercase tracking-wider">Profile
                  </th>
    ...
    combinedSortedUsers() {
      ...
      if (this.searchQuery) {
        return this.users.filter(user => {
          ...
          return user.name.toLowerCase().includes(this.searchQuery.toLowerCase()) || user.id === parseInt(this.searchQuery);
        }).sort((a, b) => {
